node{
   ...
   sh 'docker build -t vinothr448/myweb:0.0.2 .'
   }
  ...
  stage('Nexus Image Push'){
   ...
   sh "docker tag vinothr448/myweb:0.0.2 54.171.156.244:8083/damo:1.0.0"
   ...
   sh 'docker run -d -p 8090:8080 --name tomcattest vinothr448/myweb:0.0.2' 
   }
}
}
